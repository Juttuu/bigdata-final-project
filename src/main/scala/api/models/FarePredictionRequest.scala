...
case class FarePredictionRequest(
...
object FarePredictionRequest extends DefaultJsonProtocol {
  implicit val farePredictionRequestFormat = jsonFormat10(FarePredictionRequest.apply)
}
